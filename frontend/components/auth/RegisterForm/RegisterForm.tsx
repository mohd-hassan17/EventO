  ...
  return (
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        {/* Floating particles */}
        <div className="absolute w-2 h-2 bg-pink-500 rounded-full animate-bounce" style={{ top: '15%', left: '8%', animationDelay: '0s', animationDuration: '3s' }} />
        <div className="absolute w-2 h-2 bg-cyan-400 rounded-full animate-bounce" style={{ top: '70%', left: '15%', animationDelay: '1s', animationDuration: '4s' }} />
        <div className="absolute w-2 h-2 bg-purple-500 rounded-full animate-bounce" style={{ top: '30%', right: '12%', animationDelay: '2s', animationDuration: '3.5s' }} />
        <div className="absolute w-2 h-2 bg-pink-500 rounded-full animate-bounce" style={{ top: '80%', right: '20%', animationDelay: '0.5s', animationDuration: '3.2s' }} />
        <div className="absolute w-2 h-2 bg-cyan-400 rounded-full animate-bounce" style={{ top: '45%', left: '85%', animationDelay: '1.5s', animationDuration: '3.8s' }} />
        ...
        <form className="bg-gray-800/40 backdrop-blur-xl rounded-3xl p-8 border border-white/10 shadow-2xl">
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              ...
              />
              <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-purple-400/0 via-purple-400/5 to-purple-400/0 opacity-0 hover:opacity-100 transition-opacity duration-300 pointer-events-none" />
            </div>
          </div>
          ...
          <div className="mb-6">
            <label className="flex items-start space-x-3 cursor-pointer">
              ...
              <span className="text-sm text-gray-300">
                I agree to the{" "}
                <a href="/terms" className="text-cyan-400 hover:text-pink-400 hover:underline transition-colors">
                  Terms of Service
                </a>{" "}
                and{" "}
                <a href="/privacy" className="text-cyan-400 hover:text-pink-400 hover:underline transition-colors">
                  Privacy Policy
                </a>
              </span>
            </label>
